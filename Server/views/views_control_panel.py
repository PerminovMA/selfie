...
import pika
pika_connection = pika.BlockingConnection(pika.ConnectionParameters(host='82.146.45.73'))
pika_channel = pika_connection.channel()
pika_channel.queue_declare(queue='gcm_sender')#, durable=True)
# connection.close()
